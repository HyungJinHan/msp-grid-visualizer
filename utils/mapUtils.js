...
export function updateLabelScales(map) {
  ...
  document.documentElement.style.setProperty("--sub-label-opacity", subLabelOpacity);
...
/**
 * Subdivides a quadrilateral into a grid of smaller quadrilaterals.
 * Returns an array of { latlngs, label }
 */
